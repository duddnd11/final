...
<div style="margin-top: 200px;">
	...
	<main id="contents" class="wrapper-sub">
         ...
         <p style=" margin-left: 15px;font-weight: 700; font-size: 35px; float: left;"><span>님</span></p>
         </div>
		...
		<div style=" width: 900px; margin-left: 350px;  margin-top: 100px; width: 600px; display: block;">
			...
			<button style="float: right;width: 50px;hegiht: 40px;margin-right: -250px;"><a href="http://localhost:9090/final/memberupdate">수정</a></button>				
		</div>
